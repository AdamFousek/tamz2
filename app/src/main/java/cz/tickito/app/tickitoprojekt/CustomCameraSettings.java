...
/**
 * Created by adamfousek on 18.12.17.
 */

public class CustomCameraSettings extends View implements IViewFinder {
    private static final String TAG = "ViewFinderView";

    private Rect mFramingRect;

    private static final float PORTRAIT_WIDTH_RATIO = 0.9f;
    private static final float PORTRAIT_WIDTH_HEIGHT_RATIO = 1.25f;
    ...
    public CustomCameraSettings(Context context) {
        super(context);
        init();
    }

    public CustomCameraSettings(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
